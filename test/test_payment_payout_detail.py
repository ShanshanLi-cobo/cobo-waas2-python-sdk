...
class TestPaymentPayoutDetail(unittest.TestCase):
    """PaymentPayoutDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentPayoutDetail:
        """Test PaymentPayoutDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPayoutDetail`
        """
        model = PaymentPayoutDetail()
        if include_optional:
    ...
    def testPaymentPayoutDetail(self):
        """Test PaymentPayoutDetail"""
