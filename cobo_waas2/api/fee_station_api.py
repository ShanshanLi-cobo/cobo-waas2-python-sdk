...
class FeeStationApi:
    ...
    @validate_call
    def list_fee_station_fiat_transactions(
        self,
        transaction_ids: Annotated[Optional[StrictStr], Field(description="A list of transaction IDs, separated by comma.")] = None,
        transaction_type: Annotated[Optional[FeeStationFiatTransactionType], Field(description="The type of the fiat transaction. Possible values include:   - `deposit`: A deposit transaction.   - `transfer`: A transfer transaction. ")] = None,
        ...
        :param transaction_type: The type of the fiat transaction. Possible values include:   - `deposit`: A deposit transaction.   - `transfer`: A transfer transaction. 
        :type transaction_type: FeeStationFiatTransactionType
        ...
        _param = self._list_fee_station_fiat_transactions_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListFeeStationFiatTransactions200Response",
            '4XX': "ErrorResponse",
            '5XX': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def list_fee_station_fiat_transactions_with_http_info(
        self,
        transaction_ids: Annotated[Optional[StrictStr], Field(description="A list of transaction IDs, separated by comma.")] = None,
        transaction_type: Annotated[Optional[FeeStationFiatTransactionType], Field(description="The type of the fiat transaction. Possible values include:   - `deposit`: A deposit transaction.   - `transfer`: A transfer transaction. ")] = None,
        min_created_timestamp: Annotated[Optional[StrictInt], Field(description="The time when the transaction was created, in Unix timestamp format, measured in milliseconds. You can use this parameter to filter transactions created on or after the specified time.  If you specify `min_created_timestamp` without specifying `max_created_timestamp`, `max_created_timestamp` is automatically set to `min_created_timestamp` + 90 days. If you specify both, the time range cannot exceed 90 days.  If not provided, the default value is 90 days before the current time. This default value is subject to change. ")] = None,
    ...
    ) -> ApiResponse[ListFeeStationFiatTransactions200Response]:
        """List Fee Station fiat transactions
    ...
    @validate_call
    def list_fee_station_fiat_transactions_without_preload_content(
        self,
        transaction_ids: Annotated[Optional[StrictStr], Field(description="A list of transaction IDs, separated by comma.")] = None,
        transaction_type: Annotated[Optional[FeeStationFiatTransactionType], Field(description="The type of the fiat transaction. Possible values include:   - `deposit`: A deposit transaction.   - `transfer`: A transfer transaction. ")] = None,
        min_created_timestamp: Annotated[Optional[StrictInt], Field(description="The time when the transaction was created, in Unix timestamp format, measured in milliseconds. You can use this parameter to filter transactions created on or after the specified time.  If you specify `min_created_timestamp` without specifying `max_created_timestamp`, `max_created_timestamp` is automatically set to `min_created_timestamp` + 90 days. If you specify both, the time range cannot exceed 90 days.  If not provided, the default value is 90 days before the current time. This default value is subject to change. ")] = None,
    ...
    def _list_fee_station_fiat_transactions_serialize(
        self,
        transaction_ids,
        transaction_type,
        ...
        if transaction_type is not None:
            ...
            _query_params.append(('transaction_type', transaction_type.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fee_station/fiat_transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
